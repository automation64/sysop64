...
declare S64_X_MODULE_CAPS_X_CMD="${S64_X_MODULE_CAPS_X_CMD:-}"

# X_CLI_SETUP_PLACEHOLDER_X
if [[ -z "$S64_X_MODULE_CAPS_X_CMD" ]]; then
  S64_X_MODULE_CAPS_X_CMD="$(bl64_bsh_command_locate 'X_CLI_COMMAND_X')"
fi
